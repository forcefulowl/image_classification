...
model = ResNet50(input_shape=(img_width, img_height, 3), pooling='avg')
...
model_final.compile(loss="categorical_crossentropy", optimizer=optimizers.adadelta(lr=0.1), metrics=["accuracy"])
